...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $mode = Category::create(['name' => 'Mode', 'slug' => 'mode']);
        $beaute = Category::create(['name' => 'Beauté', 'slug' => 'beaute']);
        $patisserie = Category::create(['name' => 'Pâtisserie', 'slug' => 'patisserie']);
        $cuisine = Category::create(['name' => 'Cuisine', 'slug' => 'cuisine']);
